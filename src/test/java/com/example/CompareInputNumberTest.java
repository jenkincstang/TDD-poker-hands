...
public class CompareInputNumberTest {
  ...
  @Test
  void should_return_white_wins_when_compare_two_input_number_not_equal_priority_given_black_2H_2D_2S_9C_KD_and_white_2C_2H_4S_8C_AH(){
    //given
    InputNumber inputNumber1 = new InputNumber(2, "2", "H");
    InputNumber inputNumber2 = new InputNumber(2, "2", "D");
    InputNumber inputNumber3 = new InputNumber(2, "2", "S");
    InputNumber inputNumber4 = new InputNumber(9, "9", "C");
    InputNumber inputNumber5 = new InputNumber(13, "K", "D");
    List<InputNumber> blackInputNumber = new ArrayList<InputNumber>();
    blackInputNumber.add(inputNumber1);
    ...
    String expectResult = "Black wins";
  ...
  @Test
  void should_return_white_wins_when_compare_two_input_number_not_equal_priority_given_black_2H_2D_2S_9C_9D_and_white_2C_2H_4S_8C_AH(){
    //given
    InputNumber inputNumber1 = new InputNumber(2, "2", "H");
    InputNumber inputNumber2 = new InputNumber(2, "2", "D");
    InputNumber inputNumber3 = new InputNumber(2, "2", "S");
    InputNumber inputNumber4 = new InputNumber(9, "9", "C");
    InputNumber inputNumber5 = new InputNumber(9, "9", "D");
    List<InputNumber> blackInputNumber = new ArrayList<InputNumber>();
    blackInputNumber.add(inputNumber1);
    blackInputNumber.add(inputNumber2);
    blackInputNumber.add(inputNumber3);
  ...
  @Test
  void should_return_white_wins_when_compare_two_input_number_equal_priority_given_black_3H_4H_2H_KH_5H_and_white_4H_5H_2H_8H_6H(){
    //given
    InputNumber inputNumber1 = new InputNumber(3, "3", "H");
    InputNumber inputNumber2 = new InputNumber(4, "4", "H");
    InputNumber inputNumber3 = new InputNumber(2, "2", "H");
    InputNumber inputNumber4 = new InputNumber(13, "K", "H");
    InputNumber inputNumber5 = new InputNumber(5, "5", "H");
    List<InputNumber> blackInputNumber = new ArrayList<InputNumber>();
    blackInputNumber.add(inputNumber1);
    blackInputNumber.add(inputNumber2);
    blackInputNumber.add(inputNumber3);
    ...
    InputNumber inputNumber11 = new InputNumber(4, "4", "H");
    InputNumber inputNumber22 = new InputNumber(5, "5", "H");
    InputNumber inputNumber33 = new InputNumber(2, "2", "H");
    InputNumber inputNumber44 = new InputNumber(8, "8", "H");
    InputNumber inputNumber55 = new InputNumber(6, "6", "H");
    List<InputNumber> whiteInputNumber = new ArrayList<InputNumber>();
    whiteInputNumber.add(inputNumber11);
    whiteInputNumber.add(inputNumber22);
    ...
    String expectResult = "Black wins. - with high card: K";
  ...
  @Test
  void should_return_black_wins_when_compare_two_input_number_equal_priority_given_black_9H_4S_KC_KH_5H_and_white_6H_4S_KC_KH_5H(){
    //given
    InputNumber inputNumber1 = new InputNumber(9, "9", "H");
    InputNumber inputNumber2 = new InputNumber(4, "4", "S");
    InputNumber inputNumber3 = new InputNumber(13, "K", "C");
    InputNumber inputNumber4 = new InputNumber(13, "K", "H");
    InputNumber inputNumber5 = new InputNumber(5, "5", "H");
    List<InputNumber> blackInputNumber = new ArrayList<InputNumber>();
    blackInputNumber.add(inputNumber1);
    ...
    InputNumber inputNumber11 = new InputNumber(6, "6", "H");
    InputNumber inputNumber22 = new InputNumber(4, "4", "S");
    InputNumber inputNumber33 = new InputNumber(13, "K", "C");
    InputNumber inputNumber44 = new InputNumber(13, "K", "H");
    InputNumber inputNumber55 = new InputNumber(5, "5", "H");
    List<InputNumber> whiteInputNumber = new ArrayList<InputNumber>();
    whiteInputNumber.add(inputNumber11);
    whiteInputNumber.add(inputNumber22);
    whiteInputNumber.add(inputNumber33);
    ...
    String expectResult = "Black wins. - with high card: 9";
  ...
  @Test
  void should_return_black_wins_when_compare_two_input_number_equal_priority_given_black_9H_9S_KC_KH_5H_and_white_6H_6S_KC_KH_5H(){
    //given
    InputNumber inputNumber1 = new InputNumber(9, "9", "H");
    InputNumber inputNumber2 = new InputNumber(9, "9", "S");
    InputNumber inputNumber3 = new InputNumber(13, "K", "C");
    InputNumber inputNumber4 = new InputNumber(13, "K", "H");
    InputNumber inputNumber5 = new InputNumber(5, "5", "H");
    List<InputNumber> blackInputNumber = new ArrayList<InputNumber>();
    ...
    InputNumber inputNumber11 = new InputNumber(6, "6", "H");
    InputNumber inputNumber22 = new InputNumber(6, "6", "S");
    InputNumber inputNumber33 = new InputNumber(13, "K", "C");
    InputNumber inputNumber44 = new InputNumber(13, "K", "H");
    InputNumber inputNumber55 = new InputNumber(5, "5", "H");
    List<InputNumber> whiteInputNumber = new ArrayList<InputNumber>();
    ...
    String expectResult = "Black wins. - with Pair of: 9";
  ...
  @Test
  void should_return_black_wins_when_compare_two_input_number_equal_priority_given_black_2H_3H_4H_5H_6H_and_white_5H_6H_7H_8H_9H(){
    //given
    InputNumber inputNumber1 = new InputNumber(2, "2", "H");
    InputNumber inputNumber2 = new InputNumber(3, "3", "H");
    ...
    InputNumber inputNumber11 = new InputNumber(5, "5", "H");
    InputNumber inputNumber22 = new InputNumber(6, "6", "H");
    InputNumber inputNumber33 = new InputNumber(7, "7", "H");
    InputNumber inputNumber44 = new InputNumber(8, "8", "H");
    InputNumber inputNumber55 = new InputNumber(9, "9", "H");
    List<InputNumber> whiteInputNumber = new ArrayList<InputNumber>();
    whiteInputNumber.add(inputNumber11);
    whiteInputNumber.add(inputNumber22);
    whiteInputNumber.add(inputNumber33);
    ...
    String expectResult = "White wins. - with high card: 9";
